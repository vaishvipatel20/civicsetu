      ...
      <View style={styles.mapContainer}>
        ...
        >
          <View style={styles.mapPlaceholder}>
            {/* Dummy Management Map */}
            <View style={styles.managementMapBackground}>
              {/* City Grid System */}
              <View style={styles.cityGrid}>
                {/* Major Highways */}
                <View style={[styles.highway, { top: '20%', left: '0%', width: '100%', height: 6 }]} />
                <View style={[styles.highway, { top: '40%', left: '0%', width: '100%', height: 6 }]} />
                <View style={[styles.highway, { top: '60%', left: '0%', width: '100%', height: 6 }]} />
                <View style={[styles.highway, { top: '80%', left: '0%', width: '100%', height: 6 }]} />
                
                {/* Vertical Highways */}
                <View style={[styles.highway, { top: '0%', left: '25%', width: 6, height: '100%' }]} />
                <View style={[styles.highway, { top: '0%', left: '50%', width: 6, height: '100%' }]} />
                <View style={[styles.highway, { top: '0%', left: '75%', width: 6, height: '100%' }]} />
                
                {/* District Boundaries */}
                <View style={[styles.district, { top: '5%', left: '5%', width: '18%', height: '30%' }]}>
                  <Text style={styles.districtLabel}>North</Text>
                </View>
                <View style={[styles.district, { top: '5%', left: '28%', width: '18%', height: '30%' }]}>
                  <Text style={styles.districtLabel}>Central</Text>
                </View>
                <View style={[styles.district, { top: '5%', left: '51%', width: '18%', height: '30%' }]}>
                  <Text style={styles.districtLabel}>East</Text>
                </View>
                <View style={[styles.district, { top: '5%', left: '74%', width: '21%', height: '30%' }]}>
                  <Text style={styles.districtLabel}>Industrial</Text>
                </View>
                
                <View style={[styles.district, { top: '43%', left: '5%', width: '18%', height: '32%' }]}>
                  <Text style={styles.districtLabel}>West</Text>
                </View>
                <View style={[styles.district, { top: '43%', left: '28%', width: '18%', height: '32%' }]}>
                  <Text style={styles.districtLabel}>Downtown</Text>
                </View>
                <View style={[styles.district, { top: '43%', left: '51%', width: '18%', height: '32%' }]}>
                  <Text style={styles.districtLabel}>Commercial</Text>
                </View>
                <View style={[styles.district, { top: '43%', left: '74%', width: '21%', height: '32%' }]}>
                  <Text style={styles.districtLabel}>Riverside</Text>
                </View>
                
                <View style={[styles.district, { top: '83%', left: '5%', width: '40%', height: '12%' }]}>
                  <Text style={styles.districtLabel}>South Residential</Text>
                </View>
                <View style={[styles.district, { top: '83%', left: '51%', width: '44%', height: '12%' }]}>
                  <Text style={styles.districtLabel}>Airport District</Text>
                </View>
              </View>
            </View>
            
            <MapPin size={48} color="#FFFFFF" />
            <Text style={styles.mapPlaceholderText}>{t('management.map.mapView')}</Text>
            <Text style={styles.mapPlaceholderSubtext}>
              {t('management.map.showingIssues', { count: filteredIssues.length })}
            </Text>
            {currentLocation && (
        ...
        <View style={styles.markersOverlay}>
          ...
          {filteredIssues.slice(0, 10).map((issue, index) => {
            ...
            // Position issues across different districts
            const getManagementIssuePosition = (issueId: number) => {
              const positions = [
                { x: 15, y: 25 }, // North District
                { x: 37, y: 18 }, // Central District
                { x: 60, y: 22 }, // East District
                { x: 85, y: 28 }, // Industrial District
                { x: 14, y: 58 }, // West District
                { x: 37, y: 62 }, // Downtown
                { x: 60, y: 55 }, // Commercial
                { x: 85, y: 65 }, // Riverside
                { x: 25, y: 88 }, // South Residential
                { x: 73, y: 90 }, // Airport District
              ];
              return positions[index] || positions[0];
            };
            
            const position = getManagementIssuePosition(issue.id);
